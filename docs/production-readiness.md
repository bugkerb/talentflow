...
- [x] Production AI configuration fails fast: `AI_PROVIDER` is explicit, fixture is test-harness-only, provider credentials are required, and configuration errors are safe to expose
