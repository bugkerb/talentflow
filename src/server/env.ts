...
const envSchema = z.object({
  ...
  AI_PROVIDER: z.enum(["fixture", "anthropic", "openrouter"]),
  ...
  if (env.AI_PROVIDER === "fixture" && runtime !== "test") {
    ctx.addIssue({ code: "custom", path: ["AI_PROVIDER"], message: "Fixture AI provider is restricted to the test harness" });
  }
