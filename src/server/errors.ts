export const errorCodes = ["VALIDATION_ERROR", "NOT_FOUND", "CONFLICT", "INTERVIEW_CONFLICT", "IDEMPOTENCY_CONFLICT", "CALENDAR_PROVIDER_ERROR", "UNAUTHORIZED", "FORBIDDEN", "RATE_LIMITED", "AI_OUTPUT_INVALID", "AI_PROVIDER_RATE_LIMITED", "AI_PROVIDER_UNAVAILABLE", "DATABASE_ERROR", "INTERNAL_ERROR"] as const;
