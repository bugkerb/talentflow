...
export interface JobRepository { findById(id: string): Promise<JobRecord | null>; insert(job: JobRecord): Promise<JobRecord>; update(id: string, expectedVersion: number, patch: JobInput, actorId: string): Promise<JobRecord | null>; }
